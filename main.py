...
if selected == 'HOME':
    ...
    if submit_button and flag == 0:
        ...
        with open(r"E:\Capstone5\Copper-Industry\model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open(r'E:\Capstone5\Copper-Industry\scaler.pkl', 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open(r"E:\Capstone5\Copper-Industry\t.pkl", 'rb') as f:
            t_loaded = pickle.load(f)

        with open(r"E:\Capstone5\Copper-Industry\s.pkl", 'rb') as f:
...
st.write(f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Shiva</h6>', unsafe_allow_html=True)
